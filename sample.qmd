...
major_gg <- survey_results |>
  ...
  mutate(
    QID7 = case_when(
      ...
      QID7 == 'Bio' ~ 'Biology',
      QID7 == 'Cognitive A Neuroscience' ~ 'Neuroscience',
      QID7 == 'Computer Engineering' ~ 'Computer Science',
      QID7 == 'Crim' ~ 'Criminal Justice',
      ...
      QID7 == 'Marketing And History' ~ 'Marketing',
      ...
      QID7 == 'Human Service & Social Justice, Peace Studies' ~ 'Social Justice',
